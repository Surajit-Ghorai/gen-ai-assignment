"""chromadb functionalities like adding, embedding, retriving segments"""
...
PERSIST_DIRECTORY = "./db"  # please check you have a folder named 'db' inside your directory
...
def get_answer_from_palm2(question, pdf_name):
    ...
    give answer in full sentence and if you can not find any answer, then return no answer found.
    """
